...
// 사용자 지시(2026-08-21, 다섯 번째 재확인 — 채널별 시청률 그래프 지표 배치 명세 XML 제공):
// "맨 앞=타깃 시청률(항상 기본 표시), 중간=비교 시청률1, 맨 뒤=비교 시청률2" 순서로 배치하라는
// 명세와 함께, ENA Story의 비교 타깃에서 "전국 5064"를 빼고 개인2049→여자3049 순 2개로
